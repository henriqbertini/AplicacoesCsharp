 ...
 <!-- sidebar menu end-->
    ...
    ***********************************************************************************************************************
    ...
    <!--main content start-->
        ...
        <div class="form-group">
		<p><span style="font-weight:bold;margin-left:16px;">MANUAL: </span>&nbsp;&nbsp;CÓDIGO DO MANUAL - BIPE O CÓDIGO DO MANUAL DO PRODUTO</p>
        <label class="col-sm-2 col-sm-2 control-label">CÓDIGO MANUAL:</label>
        <div class="col-sm-10">
        <input style="text-transform:uppercase" required type="text" class="form-control"  id = "manual" name = "COD_MANUAL" maxlength="1000" value="" required>
        </div>
        </div>

        <div class="form-group">
		<p><span style="font-weight:bold;margin-left:16px;">CHAVE: </span>&nbsp;&nbsp;CÓDIGO DA CHAVE - BIPE O CÓDIGO DO MANUAL DO PRODUTO</p>
        <label class="col-sm-2 col-sm-2 control-label">CÓDIGO CHAVE:</label>
        <div class="col-sm-10">
        <input style="text-transform:uppercase" required type="text" class="form-control"  id = "chave" name = "COD_CHAVE" maxlength="1000" value="" required>
        </div>
        </div>
